...
for current_tag in range(0, num_queries):
    ...
    out_file = open('../../data/lists/' + pos_queries[current_tag] + '.txt','w')
    ###########################################################################
    ...
    endtime =  2192165200  #10/12/2007, at the end of im2gps queries
    ...
    while (maxtime < endtime and total_images_queried < desired_photos):
